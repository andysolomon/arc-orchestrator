---
name: orchestrate
description: Orchestrate the given task with Fable as the parent model, delegating only bounded worker contracts to Composer, Codex, or Opus routes.
---

Use Fable as the parent orchestrator for the user-supplied task. Follow the `orchestrate` skill in this plugin.
