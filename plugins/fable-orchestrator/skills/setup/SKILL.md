...
- When a backend is authenticated, report its GPT-5.6 models from the `models` block (`gpt-5.6-terra` / `gpt-5.6-luna` on Codex, `gpt-5.6-sol` on Composer). When unauthenticated, do not claim those models are available.
