...
5. **Skill-aware review.** When the repo includes skills or the user mentions `arc-creating-skill`, `writing-great-skills`, `grill-me`, or `grill-with-docs`, include matching prompts or references instead of inventing unavailable commands. Completion: prompt files distinguish installed skills from recommended skill workflows.
