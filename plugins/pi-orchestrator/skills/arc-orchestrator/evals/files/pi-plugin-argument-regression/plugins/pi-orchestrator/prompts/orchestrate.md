...
6. the best route: codex/analyze (GPT-6 Luna), codex/implement (GPT-5.6 Terra or Sol for taste-sensitive), codex/review (GPT-5.6 Terra or Sol for taste-sensitive), or composer/implement (Composer 2.5);
