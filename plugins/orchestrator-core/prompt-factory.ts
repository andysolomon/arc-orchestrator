...
export function recommendedPromptFiles(repoSignals: {
  ...
  recommendations.push({
    ...
    route: "parent-model",
    purpose: "Show the ordered CC-Fable → Codex 6 Sol → Cursor-Fable-High parent availability chain and explicit Opus/current-model orchestration commands.",
  });
  ...
  recommendations.push({
    ...
    route: "opus-review",
    purpose: "Show Opus 5.5 slash commands for high-taste read-only review.",
  });
