...
export const ROLLOUT_STAGE_ENV = "ARC_ORCHESTRATOR_ROLLOUT_STAGE";
export const ROLLOUT_OPT_IN_ENV = "ARC_ORCHESTRATOR_ROLLOUT_OPT_IN";
export const ROLLOUT_COHORT_ID_ENV = "ARC_ORCHESTRATOR_COHORT_ID";
export const ROLLOUT_COHORT_PERCENT_ENV =
  "ARC_ORCHESTRATOR_ROLLOUT_COHORT_PERCENT";
...
export const ROLLOUT_DELEGATION_DISABLE_ENV =
  "ARC_ORCHESTRATOR_ROLLOUT_DELEGATION";

export const ROLLOUT_HUMAN_APPROVED_ENV =
  "ARC_ORCHESTRATOR_ROLLOUT_HUMAN_APPROVED";

export const LEGACY_TRACE_V2_ENV = "ARC_ORCHESTRATOR_TRACE_V2";
export const LEGACY_FALLBACK_ENGINE_ENV = "ARC_ORCHESTRATOR_FALLBACK_ENGINE";
