...
| Composer orchestrator mode | required: `plugins/fable-orchestrator/skills/orchestrate/references/routing-policy.md` | required: `plugins/cursor-orchestrator/skills/orchestrate/SKILL.md` | intentional difference — Pi is Codex 5.6 Sol-first and intentionally does not expose Composer as a parent orchestrator; it may invoke `composer/implement` only as a bounded worker route. | intentional difference — Copilot is Codex 5.6 Terra-first and intentionally does not expose Composer as a parent orchestrator; it may invoke `composer/implement` only as a bounded worker route. |
| Mechanical ops: open-pr | required: `plugins/fable-orchestrator/skills/orchestrate/references/routing-policy.md` | required: `plugins/cursor-orchestrator/skills/orchestrate/SKILL.md` | required: `plugins/pi-orchestrator/skills/arc-orchestrator/SKILL.md` | required: `plugins/copilot-orchestrator/copilot-instructions.md` |
| Mechanical ops: post-github-comment | required: `plugins/fable-orchestrator/skills/orchestrate/references/routing-policy.md` | required: `plugins/cursor-orchestrator/skills/orchestrate/SKILL.md` | required: `plugins/pi-orchestrator/skills/arc-orchestrator/SKILL.md` | required: `plugins/copilot-orchestrator/copilot-instructions.md` |
| Mechanical ops: commit-push | required: `plugins/fable-orchestrator/skills/orchestrate/references/routing-policy.md` | required: `plugins/cursor-orchestrator/skills/orchestrate/SKILL.md` | required: `plugins/pi-orchestrator/skills/arc-orchestrator/SKILL.md` | required: `plugins/copilot-orchestrator/copilot-instructions.md` |
| Mechanical ops: merge | required: `plugins/fable-orchestrator/skills/orchestrate/references/routing-policy.md` | required: `plugins/cursor-orchestrator/skills/orchestrate/SKILL.md` | required: `plugins/pi-orchestrator/skills/arc-orchestrator/SKILL.md` | required: `plugins/copilot-orchestrator/copilot-instructions.md` |
