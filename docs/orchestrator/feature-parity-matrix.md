...
| Grok (Grok 4.5) availability fallback runtime | required: `plugins/fable-orchestrator/skills/grok-runtime/SKILL.md` | intentional difference — Cursor has no grok-runtime skill; second-tier availability fallback is reached through direct runner invocation (`--backend composer --route grok-*`) in the direct-worker skill. | intentional difference — Pi has no grok-runtime skill; second-tier availability fallback is documented through explicit `bin/arc-orchestrator run --backend composer --route grok-*` commands in arc-orchestrator. | intentional difference — Copilot has no grok-runtime skill; second-tier availability fallback is documented through explicit `bin/arc-orchestrator run --backend composer --route grok-*` commands in `copilot-instructions.md`. |
...
| Eco orchestrator mode | required: `plugins/fable-orchestrator/skills/orchestrate-eco/SKILL.md`, `plugins/fable-orchestrator/skills/orchestrate/references/routing-policy.md` | required: `plugins/cursor-orchestrator/skills/orchestrate/SKILL.md` | required: `plugins/pi-orchestrator/skills/arc-orchestrator/SKILL.md`, `plugins/pi-orchestrator/prompts/orchestrate.md` | required: `plugins/copilot-orchestrator/copilot-instructions.md`, `plugins/copilot-orchestrator/prompts/orchestrate.prompt.md` |
